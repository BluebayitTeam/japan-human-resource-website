...
// notice
export const GET_NOTICES_WITHOUT_PAGINATION = `${BASE_URL}/notice/api/v1/notice/all/without_pagination/`;

export const GET_PDF_DATA = `${BASE_URL}/notice/api/v1/notice/`;

//  circulars
export const GET_CIRCULARS_WITHOUT_PAGINATION = `${BASE_URL}/circular/api/v1/circular/without_pagination/all/`;

export const GET_CIRCULAR_PDF_DATA = `${BASE_URL}/circular/api/v1/circular/`;
